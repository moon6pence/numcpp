...
template <class Array1, typename T, typename U, T Function(U)>
...
#define MAP_FUNC1(ARRAY_FUNC, ELEMENT_FUNC)\
	...
	lazy_array_with_unary_function<\
		Array1, \
		decltype(ELEMENT_FUNC(typename Array1::element_type())), \
		typename Array1::element_type, \
		ELEMENT_FUNC> \
...
namespace element_func
{
	...
	template <typename T, typename U> T cast(U a) 
	{ 
...
lazy_array_with_unary_function<
	...
	T, 
	typename Array1::element_type, 
	element_func::cast<T, typename Array1::element_type>> 
	array_cast(const Array1 &a1)
{
	return lazy_array_with_unary_function<
		Array1, 
		T, 
